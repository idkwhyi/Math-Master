            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (newUsername.isEmpty() || newPassword.isEmpty()) {
                    JOptionPane.showMessageDialog(RegisterPage.this,
                            "Username and password cannot be empty. Please fill in all fields.", "Input Error",
                            JOptionPane.WARNING_MESSAGE);
                    return;
                }

                boolean registrationSuccess = databaseManager.registerUser(newUsername, newPassword);
